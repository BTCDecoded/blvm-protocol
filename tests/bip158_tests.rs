...
fn create_coinbase_transaction() -> Transaction {
    Transaction {
        ...
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
fn test_build_block_filter_with_multiple_transactions() {
    ...
    let tx1 = create_test_transaction_with_outputs(vec![vec![
        blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
        0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
    ]]);
    let tx2 = create_test_transaction_with_outputs(vec![vec![
        blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22,
...
fn test_build_block_filter_with_previous_scripts() {
    ...
    let tx = create_test_transaction_with_outputs(vec![vec![
        blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    let previous_scripts = vec![vec![
        blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33,
...
fn test_match_filter_positive_match() {
    ...
    let script = vec![
        blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44,
...
fn test_match_filter_negative_match() {
    ...
    let script_in_block = vec![
        blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
        0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55,
    ];
    let script_not_in_block = vec![
        blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
...
fn test_match_filter_with_previous_scripts() {
    ...
    let script_in_output = vec![
        blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77,
        0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77,
    ];
    let script_in_previous = vec![
        blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88,
...
fn test_filter_roundtrip() {
    ...
    let scripts = vec![
        vec![
            blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99,
            0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99,
        ],
        vec![
            blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
...
fn test_filter_with_duplicate_scripts() {
    ...
    let script = vec![
        blvm_consensus::opcodes::OP_DUP,
        blvm_consensus::opcodes::OP_HASH160,
        blvm_consensus::opcodes::PUSH_20_BYTES, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb,
